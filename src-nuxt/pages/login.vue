<template>
  <div class="flex min-h-screen flex-col items-center justify-center bg-gray-100">
    <h1 class="mb-6 text-4xl font-bold text-purple-600">Se connecter</h1>

    <form class="w-full max-w-sm rounded-lg bg-white p-6 shadow-md">
      <div class="mb-4">
    ...
    <p class="mt-4 text-sm text-gray-500">
      ...
      <nuxt-link to="/register" class="text-purple-600 hover:underline">S'inscrire</nuxt-link>
    </p>
  </div>
</template>
